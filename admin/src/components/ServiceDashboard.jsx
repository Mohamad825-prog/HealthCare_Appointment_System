...
import { DollarSign, Calendar, CheckCircle, ClipboardList, XCircle } from 'lucide-react';
...
const ServiceDashboard = ({ services: servicesProp = null }) => {
    ...
    // Make sure that service are present
    useEffect(() => {
        ...
        // Refetch when window/tab gets focused to get the latest data
        function onFocus() {
            fetchServices({ showLoading: false });
        }
        ...
        // Listen to storage changes to get updates from other tabs
        ...
        <div className={serviceDashboardStyles.container}>
            <div className={serviceDashboardStyles.innerContainer}>
                ...
                <div className={serviceDashboardStyles.header.container}>
                    <div>
                        ...
                        <p className={serviceDashboardStyles.header.subtitle}>
                            Overview of all services, appointments, and earnings.
                        </p>
                    </div>
                ...
                <div className={serviceDashboardStyles.statGrid}>
                    ...
                    />
                    <StatCard
                        icon={<DollarSign size={18} />} // Changed from BadgeIndianRupee
                                ...
                                return (
                                    <div key={s.id} className={serviceDashboardStyles.table.row}>
                                        ...
                                        <div className={serviceDashboardStyles.table.desktopView}>
                                            ...
                                            <div
                                                className={serviceDashboardStyles.table.desktopCenterCell(1)}
                                            >
                                                {s.totalAppointments}
                                            </div>
                                            <div
