...
import { EyeClosed, Search, Trash2, Users } from 'lucide-react';
...
// This will convert schedule-like object/array to a map of dateString -> array
...
// This will give you sorted date strings with past dates first and future dates later
...
const ListPage = () => {
    ...
    // Show doctor according to filter and search
            ...
            <main className={doctorListStyles.gridContainer}>
                ...
                {!loading && filtered.length === 0 && (
                    <div className={doctorListStyles.noResultsContainer}>
                        No doctors found. Try adjusting your search or filter criteria.
                    </div>
                )}
