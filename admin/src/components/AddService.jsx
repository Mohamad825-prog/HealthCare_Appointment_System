...
const AddService = ({ serviceId }) => {
    ...
    // Date/time controls for adding new slots
    const now = new Date();
    ...
    // Convert selected 12Hrs component to a Date object
    ...
    // To prevent adding past date/time slots
    ...
    // Submit function for creation or update of service
                        ...
                        <div className={addServiceStyles.grids.formFields}>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="$ 80"  // Changed from ₹ 80 to $ 80
