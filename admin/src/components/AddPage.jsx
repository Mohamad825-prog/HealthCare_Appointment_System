...
import { CheckCircle, Eye, EyeClosed, User, XCircle } from 'lucide-react';
import { Plus, Trash2, Calendar } from 'lucide-react';

// Helper Functions

// This function will give output in minutes for a given time string like "02:30 PM"
...
// This function will give output in "DD MMM YYYY" format for a given ISO date string like "2024-06-15"
...
const AddPage = () => {
    ...
    // To compute date in local timezone
    ...
    // It will auto hide toast after 3 seconds
    useEffect(() => {
    ...
    // To handle image selection and preview
    ...
    // To remove selected image and preview
    ...
    // To add a new slot to the form state after validating date and time
    function addSlotToForm() {
        ...
        // If the slot is for today, ensure the time is in the future
        if (slotDate === today) {
            const now = new Date();
    ...
    // To remove a slot from form state based on date and time
    ...
    // To convert the schedule object into a flat array of slots with date and time for easier rendering
    ...
    // To handle form submission, send data to server, and update UI based on response
    ...
    return (
        <div className={s.pageContainer}>
            ...
            {/* Doctor List Section (can be used to display added doctors) */}
            <div className={s.doctorListContainer}>
                {doctorList.length ? (
                    ...
                    <p className={s.emptyState}>No doctors available.</p>
                )}
