...
import { DollarSign, CalendarRange, CheckCircle, UserRoundCheck } from 'lucide-react';
...
// Helper functions to fetch patient count
...
const DashboardPage = () => {
    ...
    // To filter doctors based on the search query
            ...
            <div className={s.maxWidthContainer}>
                <div className={s.headerContainer}>
                    <div>
                        ...
                        <p className={s.headerSubtitle}>
                            Welcome to your dashboard! Here you can manage your appointments, view patient records, and access important information at a glance.
                        </p>
                    </div>
                </div>
                ...
                <div className={s.statsGrid}>
                    ...
                    <StatCard icon={<CheckCircle className=" w-6 h-6" />}
                        label="Completed Appointments" value={totals.completed}
                    />

                    <StatCard icon={<XCircle className=" w-6 h-6" />}
                        label="Canceled Appointments" value={totals.canceled}
                    />
                </div>
        ...
        <div className={s.mobileDoctorCard}>
            <div className={s.mobileDoctorHeader}>
                ...
                <div>
                    ...
                    <div className={s.mobileStatValue + " " + s.textRed600}>
                        {d.appointments.canceled}
                    </div>
                </div>
            </div>
