...
export default function ListServicePage() {
    ...
    // Convert array of slots into slot objects
    ...
    // Gives output with date and time like DD-MM-YYYY, hour, minute, ampm
    ...
    // To find duplicate slot in the list of slots
    ...
    // Formate the slot for backend ex-DD-MM-YYYY with time and am/pm
    ...
    // To edit any service we save then for a particular service id
    ...
    // To filter the service by name and availability
