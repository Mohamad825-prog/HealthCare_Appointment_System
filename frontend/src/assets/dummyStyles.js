...
export const certificationStyles = {
  ...
  logoImage: "w-16 h-16 rounded-full object-cover shadow-lg border-2 border-emerald-300 transition-all duration-500", 
...
export const navbarStyles = {
  ...
  logoImageWrapper: "relative flex items-center justify-center overflow-hidden p-2 mx-1 h-full w-full pt-4",
...
export const homePageStyles = {
  ...
  // ── View-all link (reused across doctor / service preview sections) ──────────
  viewAllContainer: "flex justify-center mt-10",
  viewAllBtn: "inline-flex items-center gap-2 px-7 py-3 border-2 border-emerald-400 text-emerald-700 font-semibold rounded-full hover:bg-emerald-50 transition-all duration-300",

  // ── Hero ─────────────────────────────────────────────────────────────────────
  heroSection: "relative min-h-[90vh] bg-linear-to-br from-emerald-50 via-white to-teal-50 flex items-center overflow-hidden font-serif",
  heroBg1: "absolute top-0 right-0 w-[600px] h-[600px] bg-emerald-100 rounded-full blur-3xl opacity-40 -translate-y-1/3 translate-x-1/3 pointer-events-none",
  heroBg2: "absolute bottom-0 left-0 w-[500px] h-[500px] bg-teal-100 rounded-full blur-3xl opacity-30 translate-y-1/3 -translate-x-1/3 pointer-events-none",
  heroContainer: "relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 w-full",
  heroGrid: "grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center",
  heroLeft: "text-center lg:text-left",
  heroBadge: "inline-flex items-center gap-2 px-4 py-2 bg-emerald-100 border border-emerald-200 rounded-full text-sm font-semibold text-emerald-700 mb-6",
  heroBadgeDot: "w-2 h-2 bg-emerald-500 rounded-full animate-pulse",
  heroTitle: "text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6 font-[pacifico]",
  heroTitleGradient: "text-transparent bg-clip-text bg-linear-to-r from-emerald-600 to-teal-500",
  heroSubtitle: "text-lg text-gray-500 mb-8 max-w-lg mx-auto lg:mx-0 leading-relaxed",
  heroButtons: "flex flex-col sm:flex-row gap-4 justify-center lg:justify-start",
  heroPrimaryBtn: "inline-flex items-center justify-center gap-2 px-8 py-4 bg-linear-to-r from-emerald-500 to-teal-500 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5",
  heroSecondaryBtn: "inline-flex items-center justify-center gap-2 px-8 py-4 border-2 border-emerald-300 text-emerald-700 font-semibold rounded-full hover:bg-emerald-50 transition-all duration-300",
  heroStats: "flex gap-8 mt-12 justify-center lg:justify-start",
  heroStatItem: "text-center lg:text-left",
  heroStatValue: "text-3xl font-bold text-emerald-700",
  heroStatLabel: "text-xs text-gray-400 mt-1 uppercase tracking-wide",
  heroRight: "relative hidden lg:flex items-center justify-center",
  heroImageWrapper: "relative w-full max-w-md h-[480px] rounded-3xl overflow-hidden shadow-2xl border border-emerald-100",
  heroImage: "w-full h-full object-cover object-center",
  heroImageOverlay: "absolute inset-0 bg-linear-to-t from-emerald-900/20 via-transparent to-transparent",
  heroCard1: "absolute bottom-6 left-6 bg-white rounded-2xl p-4 shadow-xl border border-emerald-100 flex items-center gap-3 home-float",
  heroCard2: "absolute top-6 right-6 bg-white rounded-2xl px-5 py-3 shadow-xl border border-emerald-100 text-center home-float-delayed",
  heroCardIcon: "w-10 h-10 bg-emerald-100 rounded-xl flex items-center justify-center flex-shrink-0",
  heroCardLucide: "w-5 h-5 text-emerald-600",
  heroCardText: "text-sm font-bold text-gray-800",
  heroCardSub: "text-xs text-gray-400",

  // ── Benefits ─────────────────────────────────────────────────────────────────
  benefitsSection: "py-20 bg-white font-serif",
  benefitsContainer: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",
  benefitsHeader: "text-center mb-14",
  benefitsTitle: "text-3xl sm:text-4xl font-bold text-gray-900 mb-4 font-[pacifico]",
  benefitsTitleSpan: "text-emerald-600",
  benefitsSubtitle: "text-gray-500 max-w-2xl mx-auto text-base sm:text-lg",
  benefitsGrid: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8",
  benefitCard: "group bg-white border border-gray-100 rounded-2xl p-8 text-center shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300",
  benefitIconWrapper: "w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-5 group-hover:scale-110 transition-transform duration-300",
  benefitIcon: "w-8 h-8",
  benefitTitle: "text-lg font-bold text-gray-900 mb-2",
  benefitText: "text-gray-500 text-sm leading-relaxed",

  // ── Services section wrapper ──────────────────────────────────────────────────
  servicesSection: "py-20 bg-linear-to-br from-slate-50 to-emerald-50 font-serif",
  servicesContainer: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",
  servicesHeader: "text-center mb-14",

  // ── Shared section title helpers ──────────────────────────────────────────────
  sectionTitle: "text-3xl sm:text-4xl font-bold text-gray-900 mb-4 font-[pacifico]",
  sectionTitleSpan: "text-emerald-600",
  sectionSubtitle: "text-gray-500 max-w-2xl mx-auto text-base sm:text-lg",

  // ── How It Works ─────────────────────────────────────────────────────────────
  howSection: "py-20 bg-white font-serif",
  howContainer: "max-w-5xl mx-auto px-4 sm:px-6 lg:px-8",
  howHeader: "text-center mb-14",
  howGrid: "grid grid-cols-1 md:grid-cols-3 gap-10",
  howCardWrapper: "relative",
  howCard: "relative bg-emerald-50 border border-emerald-100 rounded-2xl p-8 text-center shadow-sm pt-10",
  howStepNumber: "absolute -top-4 left-1/2 -translate-x-1/2 w-9 h-9 rounded-full bg-linear-to-r from-emerald-500 to-teal-500 text-white font-bold text-base flex items-center justify-center shadow-lg",
  howConnector: "hidden md:block absolute top-1/2 -right-5 z-10 w-10 h-0.5 bg-emerald-200",
  howIconWrapper: "w-14 h-14 bg-white rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-md",
  howIcon: "w-7 h-7 text-emerald-600",
  howStepTitle: "text-lg font-bold text-gray-900 mb-2",
  howStepText: "text-gray-500 text-sm leading-relaxed",

  // ── Testimonials ─────────────────────────────────────────────────────────────
  testimonialsSection: "py-20 bg-linear-to-br from-emerald-50 to-teal-50 font-serif",
  testimonialsContainer: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",
  testimonialsHeader: "text-center mb-14",
  testimonialsGrid: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",
  testimonialCard: "bg-white rounded-2xl p-6 shadow-md border border-emerald-50 flex flex-col gap-4 hover:shadow-xl transition-shadow duration-300",
  testimonialStars: "flex gap-0.5",
  testimonialStar: "w-4 h-4 text-yellow-400 fill-yellow-400",
  testimonialStarEmpty: "w-4 h-4 text-gray-200 fill-gray-200",
  testimonialQuote: "text-gray-600 italic text-sm leading-relaxed flex-1",
  testimonialAuthor: "flex items-center gap-3",
  testimonialAvatar: "w-12 h-12 rounded-full object-cover border-2 border-emerald-100",
  testimonialName: "text-sm font-bold text-gray-900",
  testimonialRole: "text-xs text-emerald-600",

  // ── Final CTA ─────────────────────────────────────────────────────────────────
  ctaSection: "py-24 bg-linear-to-r from-emerald-600 via-teal-600 to-emerald-700 relative overflow-hidden font-serif",
  ctaBg1: "absolute top-0 right-0 w-72 h-72 bg-white/10 rounded-full -translate-y-1/2 translate-x-1/2 pointer-events-none",
  ctaBg2: "absolute bottom-0 left-0 w-72 h-72 bg-white/10 rounded-full translate-y-1/2 -translate-x-1/2 pointer-events-none",
  ctaContainer: "relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center",
  ctaTitle: "text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 font-[pacifico] leading-tight",
  ctaSubtitle: "text-emerald-100 text-base sm:text-lg mb-10 max-w-xl mx-auto",
  ctaButtons: "flex flex-col sm:flex-row gap-4 justify-center",
  ctaPrimaryBtn: "inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-emerald-700 font-bold rounded-full shadow-xl hover:shadow-2xl hover:-translate-y-0.5 transition-all duration-300",
  ctaSecondaryBtn: "inline-flex items-center justify-center gap-2 px-8 py-4 border-2 border-white/60 text-white font-semibold rounded-full hover:bg-white/10 transition-all duration-300",

  // ── Floating card animations (injected via <style> tag) ──────────────────────
  animationStyles: `
    @keyframes homeFloat {
      0%, 100% { transform: translateY(0px); }
      50% { transform: translateY(-8px); }
    }
    @keyframes homeFloatDelayed {
      0%, 100% { transform: translateY(0px); }
      50% { transform: translateY(-6px); }
    }
    .home-float { animation: homeFloat 4s ease-in-out infinite; }
    .home-float-delayed { animation: homeFloatDelayed 4s ease-in-out 1.5s infinite; }
  `
};
